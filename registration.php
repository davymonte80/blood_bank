...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#green; border-radious:2px; border:solid blackd; box-shadow:10px 1px 20px black;" radious: 2px;>
     <form method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >

    <tr><td colspan="2"  align="center"><h1><marquee>DONOR REGISTRATION <marquee></h1></td></tr>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved MonteDavid |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
